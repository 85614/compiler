...
struct ExprNode : public ASTNode
{
    ...
    virtual void output(std::ostream &os) override { delete calValue(os); }
    virtual ValPtr *calValue(std::ostream &os, bool getAddr = false) { notImplement("calValue");return nullptr; }
...
struct OP1ExprNode : public ExprNode
{
    ...
    virtual ValPtr *calValue(std::ostream &os, bool getAddr = false) override;
